...
const MOVE_LIST: { name: string; input: string; desc: string; requires?: string; element?: boolean }[] = [
  ...
  { name: 'Lock On', input: 'Tab / MMB', desc: 'Frame a target; breath and bursts aim at it.' },
];
...
export class Menus {
  ...
  private showControls(): void {
    ...
    const rows: [string, string, string][] = [
      ...
      ['Lock on', 'Tab / middle mouse', 'RB'], ['Change element', '1-4, mouse wheel, R', 'D-pad'], ['Interact', 'F', 'L3'], ['Pause', 'Esc', 'Start'],
    ];
